...
public class SimpleAdapterExercise extends BaseSimpleAdapter<Exercise, RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case ENTRY_VIEW: {
                return new EntryViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_exercise_entry, parent, false));
            }
            case HEADER_VIEW: {
                return new EntryViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.frg_create_workout_header, parent, false));
            }
            default: {
